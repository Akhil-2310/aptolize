                    ...
                    <div className="flex flex-col items-center justify-center py-20 h-full">
                        <button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
                            ...
                            <span className="z-10 py-0.5 text-md text-neutral-100 flex items-center justify-center gap-1.5">
                                ...
                                <span className="bg-[linear-gradient(to_right,#F87AFF,#FB93D0,#FFDD99,#C3F0B2)] text-transparent bg-clip-text [-webkit-background-clip:text]">Introducing Aptolize</span>
                        ...
                        <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
                            ...
                            <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                                Grow your money with Aptolize!<br />Enjoy fixed interest rate on your deposits and unlock daily chances to win big rewards.</p>
