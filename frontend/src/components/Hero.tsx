      ...
      <div className="container relative">
        <div className="flex items-center justify-center">
          <Link href={"/"} className="inline-flex gap-2 border py-2 px-3 rounded-xl border-white border-opacity-30">
            <span className="bg-[linear-gradient(to_right,#F87AFF,#FB93D0,#FFDD99,#C3F0B2)] text-transparent bg-clip-text [-webkit-background-clip:text]">Aptolize</span>
        ...
        <div className="flex justify-center">
          ...
          Maximize your USDT holdings with our innovative staking and reward platform. Earn high yeild along with daily rewards.
          </p>
        </div>
        <div className="flex justify-center mt-8 ">
          <Link href={"/app"}>          
